...
public class MainActivity extends BaseActivity implements OnClickListener,
	...
	private String mShareEndStr = "share";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		timer.schedule(task, 1000 * 4, 1000 * 30*60); //启动timer
	}
	...
	protected void onResume() {
		...
		if (!mTmpCities.isEmpty()) {
			...
			if(PreferenceUtils.getPrefBoolean(this, FIRST_RUN_APP, true)){
				Toast.makeText(MainActivity.this, "立即体验", 1).show();
	...
	private void updateUI() {
		...
		if(weather_ !=null&&temp_ !=null){
		
			if(weather_.equals("晴")){
				Toast.makeText(MainActivity.this, "晴好天气,多进行户外运动", 1).show();
			}
		}
	}
...
//			mBlurImageView.setBackgroundResource(android.R.color.white);
